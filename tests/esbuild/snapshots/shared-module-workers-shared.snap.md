# shared-module-workers-shared (esbuild)
...
```js
// tests/esbuild/tmp/shared-module-workers-shared/input/index.js
...
```js
// tests/esbuild/tmp/shared-module-workers-shared/input/shared.js
function sharedUtil(name) {
  return `Hello from ${name} using shared module!`;
}

// tests/esbuild/tmp/shared-module-workers-shared/input/worker1.js
self.postMessage(sharedUtil("Worker 1"));
```
...
// tests/esbuild/tmp/shared-module-workers-shared/input/worker2.js
self.postMessage(sharedUtil("Worker 2"));
```
