# shared-module-workers-shared (rollup)
...
```js
const worker1Url = new URL('tests-rollup-tmp-shared-module-workers-shared-input-worker1.js?esm', import.meta.url);
const worker2Url = new URL('tests-rollup-tmp-shared-module-workers-shared-input-worker2.js?esm', import.meta.url);
...
export { sharedUtil as s };
```

### tests-rollup-tmp-shared-module-workers-shared-input-worker1.js
...
### tests-rollup-tmp-shared-module-workers-shared-input-worker2.js
