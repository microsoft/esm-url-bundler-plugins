# shared-module-workers-isolated (rollup)
...
```js
const worker1Url = new URL('tests-rollup-tmp-shared-module-workers-isolated-input-worker1.js?esm', import.meta.url);
const worker2Url = new URL('tests-rollup-tmp-shared-module-workers-isolated-input-worker2.js?esm', import.meta.url);
...
### tests-rollup-tmp-shared-module-workers-isolated-input-worker1.js
...
### tests-rollup-tmp-shared-module-workers-isolated-input-worker2.js
