...
/*!******************!*\
  ...
  \******************/
// The URL is created inline with the Worker constructor
const worker = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("worker_js_esm"), __webpack_require__.b), { type: undefined });
worker.onmessage = (e) => console.log('[WORKER_OK]', e.data);
